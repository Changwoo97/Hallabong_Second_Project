		...
		<form:form action="${root}order/order_proc" method="post" modelAttribute="ord">
			...
			<div style="display: none">
				<c:forEach var="pair" items="${prodList}">
					<input type="checkbox" name="prodList" value="${pair.item1.no}"
						checked="checked">
				</c:forEach>
			</div>
			...
			<table style="width: 800px; margin-left: auto; margin-right: auto">
				<tr>
					<td>주문인 이름</td>
					<td colspan="3"><form:input path="ordr_name" readonly="true" size="50" /></td>
				</tr>
				<tr>
					<td>주문인 전화번호</td>
					<td><form:input path="ordr_tel" readonly="true" size="50" /></td>
				</tr>
				<tr>
					<td>주문인 주소</td>
					<td><form:input path="ordr_addr" readonly="true" size="50" /></td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					<td>수령인 이름</td>
					<td><form:input path="recv_name" size="50" /></td>
				</tr>
				<tr>
					<td>수령인 전화번호</td>
					<td><form:input path="recv_tel" size="50" /></td>
				</tr>
				<tr>
					<td>수령인 주소</td>
					<td><form:input path="recv_addr" size="50" readonly="true" /></td>
				</tr>
				<tr>
					<td>수령인 상세 주소</td>
					<td><form:input path="recv_addr_detail" size="50" /></td>
				</tr>
				<tr>
					<td>배송료</td>
					<td><form:input path="dlvy_fee" readonly="true" size="50" /></td>
				</tr>
				<tr>
					<td>결제수단</td>
					<td>
			...
			<button class="btn btn-primary"
				style="background-color: #F7D358; border-style: none; color: black;">결제하기</button>
		</form:form>
	</div>
