...
<link type="text/css" rel="stylesheet"
	href="${root}css/mainPage.css?after" />
</head>
...
<body>
	...
	<nav class="navigator">
		<ul>
			<li class="navigator-link">공지사항</li>
	...
	<section>
		...
		<a name="mainCategory"></a>
			...
			<div class="Info">
				...
				<h2><a href="${root }category/main" class="navigator-link">카테고리</a></h2>
			</div>
							...
							<div class="card-body">
								...
								<table class="table table-hover" id='board_list'>
									...
									<tbody>
										...
										<tr>
											<td class="text-center">5</td>
											<th><a href='board_read.html'>돈내놔</a></th>
											<td class="text-center d-none d-xl-table-cell">2018-12-12</td>
										</tr>
									</tbody>
								</table>
